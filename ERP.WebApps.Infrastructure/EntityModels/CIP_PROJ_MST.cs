...
{
    public partial class CIP_PROJ_MST
    {
        ...
        public string? CIP_ACCT_NO { get; set; }
        public string? FA_ACCT_NO { get; set; }
        ...
        public string C_ACTIVE_CODE { get; set; } = null!;
        public decimal? C_SUB_PROJ_COST { get; set; }
        public decimal? C_SUB_PROJ_COST_ADJ { get; set; }
    }
}
